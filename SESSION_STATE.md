...
> 후속 2차 개편에서는 T60-I를 C로 이동해 지도와 상세 분류를 맞췄고,
> 구현과 현재 결과가 모두 있는 A 8개·B 2개·C 2개에만 초록 체크를 표시했다.
> 체크는 PASS가 아니라 결과 확인 가능 표시다. 미표시 T43·T61·T62·T90·T91의
> 남은 개발·외부 입력과 완료 기준은 2차 HTML 및 `CODEX_HANDOFF.md` §12가
> 정본이다.
